...
gallery/starrating/1.1/starrating
gallery/starrating/1.1/index
...
KISSY.add('gallery/starrating/1.1/starrating',function(S, undefined) {
    var DOT = '.', EMPTY = '';
...
KISSY.add('gallery/starrating/1.1/index',function(S, SL){
    return SL;
}, {
    requires:["./starrating"]
});
